...
public:
	...
	virtual BWVector3D Sample(const BWVector3D&p, float u, float v, BWVector3D &Ns);
	virtual BWVector3D Sample(float u, float v, BWVector3D &Ns);
...
public:
	...
	BWVector3D Sample(float u, float v, BWVector3D &Ns) override;
