...
void RTSamplerRenderer<SceneType>::RenderScene(SceneType* Scene)
{
	if (!Camera)  return;
...
template<typename SceneType>
void RTSamplerRendererTask<SceneType>::Run()
{
...
template<typename SceneType>
RTSamplerRendererTask<SceneType>::~RTSamplerRendererTask()
{

}

template<typename SceneType>
RTSamplerRendererTask<SceneType>::RTSamplerRendererTask(RTSamplerRenderer<SceneType> *Render, int StarPixelIndex, int EndPiexlIndex)
{
	this->Render = Render;
